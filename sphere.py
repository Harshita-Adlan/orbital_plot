...
def genDensity(length, width, height, nl, nw, nh, l0, w0, h0, orbital,inFunc=None):
    '''
...
def writeDens(inMat,length, width, height, l0, w0, h0,filename):
    '''
    ...
    * Note that I define the zero coordinate at the negative extent of the box - This is an arbitrary choice.
    ...
    with open(filename+'.xsf','w') as outFile:
        # Write header
...
#%%
a = genDensity(25,25,25,50,50,50,-25,-25,-25,(4,3,1))
writeDens(a,50,50,50,25,25,25,"431")